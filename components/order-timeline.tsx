  ...
  return (
    <div className="grid gap-2 sm:grid-cols-4">
      {labels.map(([key, label]) => {
        ...
        return (
          <div key={key} className={`rounded-2xl border p-3 text-sm font-bold ${done ? "border-leaf-100 bg-leaf-50 text-leaf-700" : "border-stone-200 bg-stone-50 text-stone-500"}`}>
